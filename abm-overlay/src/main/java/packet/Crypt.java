...
public class Crypt
{
     ...
     */
    public final static byte staticServerPacketCode = 0x54;
    /**
     * Static xor key
     */
    ...
    public final int enableKey()
    {
        ...
        { (byte) (key & 0xff), (byte) ((key >> 8) & 0xff), (byte) ((key >> 16) & 0xff), (byte) ((key >> 24) & 0xff), (byte) 0xa1, (byte) 0x6c, (byte) 0x54, (byte) 0x87 };
     ...
     */
    public final boolean decrypt(final ByteBuffer buf)
    {
        if (!isEnabled)
        {
            return false;
        ...
        long oldKey = (((long) clientPacketKey[0] & 0xff) << 0) | (((long) clientPacketKey[1] & 0xff) << 8) | (((long) clientPacketKey[2] & 0xff) << 16) | (((long) clientPacketKey[3] & 0xff) << 24)
                | (((long) clientPacketKey[4] & 0xff) << 32) | (((long) clientPacketKey[5] & 0xff) << 40) | (((long) clientPacketKey[6] & 0xff) << 48) | (((long) clientPacketKey[7] & 0xff) << 56);
     ...
     */
    private boolean validateClientPacket(final ByteBuffer buf)
    {
     ...
     * @param buf
     */
    public final void encrypt(final ByteBuffer buf)
    {
        if (!isEnabled)
        {
        ...
        /** oldKey value as long */
        long oldKey = (((long) serverPacketKey[0] & 0xff) << 0) | (((long) serverPacketKey[1] & 0xff) << 8) | (((long) serverPacketKey[2] & 0xff) << 16) | (((long) serverPacketKey[3] & 0xff) << 24)
                | (((long) serverPacketKey[4] & 0xff) << 32) | (((long) serverPacketKey[5] & 0xff) << 40) | (((long) serverPacketKey[6] & 0xff) << 48) | (((long) serverPacketKey[7] & 0xff) << 56);
     ...
     */
    public static byte encodeOpcodec(final int op)
    {
