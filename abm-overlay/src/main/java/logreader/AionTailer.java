 ...
 * 
 * <h2>1. Create a AionTailerListener implementation</h2>
 * <p>
 * First you need to create a {@link AionTailerListener} implementation
 * ({@link AionTailerListenerAdapter} is provided for convenience so that you don't have to
 * implement every method).
 * </p>
 *
 * <p>For example:</p>
 * <pre>
 *  public class MyAionTailerListener extends AionTailerListenerAdapter {
 ...
 *     <ul>
 *       <li>{@link Tailer#create(File, AionTailerListener)}</li>
 *       <li>{@link Tailer#create(File, AionTailerListener, long)}</li>
 *       <li>{@link Tailer#create(File, AionTailerListener, long, boolean)}</li>
 *     </ul>
 *   </li>
 ...
 *
 * <pre>
 *      AionTailerListener listener = new MyAionTailerListener();
 ...
 * @see AionTailerListener
 * @see AionTailerListenerAdapter
 ...
 */
public class AionTailer implements Runnable {
     ...
     */
    private final AionTailerListener listener;
     ...
     * @param listener the AionTailerListener to use.
     */
    public AionTailer(final File file, final AionTailerListener listener) {
     ...
     */
    public AionTailer(final File file, final AionTailerListener listener, final long delayMillis) {
     ...
     */
    public AionTailer(final File file, final AionTailerListener listener, final long delayMillis, final boolean end) {
     ...
     * @param bufSize Buffer size
     */
    public AionTailer(final File file, final Charset cset, final AionTailerListener listener, final long delayMillis,
     ...
     */
    public static AionTailer create(final File file, final AionTailerListener listener, final long delayMillis,
     ...
     * @return The new tailer
     */
    public static AionTailer create(final File file, final Charset charset, final AionTailerListener listener,
                                final long delayMillis, final boolean end, final boolean reOpen
            ,final int bufSize) {
        final AionTailer tailer = new AionTailer(file, charset, listener, delayMillis, end, reOpen, bufSize);
     ...
     * @return The new tailer
     */
    public static AionTailer create(final File file, final AionTailerListener listener) {
    ...
    /**
     * Follows changes in the file, calling the AionTailerListener's handle method for each new line.
     */
    public void run() {
        ...
        try {
            ...
            while (getRun()) {
                ...
                if (length < position) {
                    ...
                    DISABLING THIS PART SINCE IT SEEMS TO HAPPEN OFTEN
    ...
    private long readLines(final RandomAccessFile reader) throws IOException {
        ...
        if (listener instanceof AionTailerListenerAdapter) {
            ((AionTailerListenerAdapter) listener).endOfFileReached();
        }
