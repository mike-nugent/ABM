...
{
	final ImageView openLock = new ImageView(IconLoader.loadFxImage("open-lock.png", 20));
	final ImageView closeLock = new ImageView(IconLoader.loadFxImage("close-lock.png", 20));
